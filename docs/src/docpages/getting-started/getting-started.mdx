...
description: 'Guide on how to install and setup Tunaiku UI Web in your project.'
---

Tunaiku UI Web can be installed via **package managers** like `yarn` or `npm`.
...
Upon installation, `@tunaiku-ui-web/core` and all its underlying packages will be accessible from
...
`@tunaiku-ui-web/<package-name>/<package-name>.scss` format. For example:

```scss
@import '@tunaiku-ui-web/color/color.scss';
@import '@tunaiku-ui-web/typography/typography.scss';
```
...
// or
@import '@tunaiku-ui-web/color/scss/index.scss';
@import '@tunaiku-ui-web/typography/scss';
@import '@tunaiku-ui-web/shape/scss';
```
